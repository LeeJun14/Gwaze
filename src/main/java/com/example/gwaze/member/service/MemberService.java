...
import com.example.gwaze.member.dto.MemberGetResponse;
...
public class MemberService {
    ...
    public MemberCreateResponse save(MemberCreateRequest request) {
        ...
        return new MemberCreateResponse(savedMember.getMemberId(), savedMember.getMemberName());
    }
    ...
    public List<MemberGetResponse> findAll() {
        ...
        for (Member member : members) {
            MemberGetResponse dto = new MemberGetResponse(member.getMemberId(), member.getMemberName());
            dtos.add(dto);
        }
        return dtos;
    }
    ...
    public MemberGetResponse findOne(Long memberId) {
        ...
        return new MemberGetResponse(member.getMemberId(), member.getMemberName());
    }
}
